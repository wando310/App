...
export default function ListLunch({array}){     

    const navigation = useNavigation()

    function renderItem({ item }) {
        return (
            <TouchableOpacity onPress={ ()=> navigation.reset({ routes: [{ name: "Modal", params:{ item: item, array: lunchArray }}]})} style={styles.container}>
