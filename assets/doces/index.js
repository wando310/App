...
import sweetArray from './sweetArray';


const ListSweet = ({array}) => {

    const navigation = useNavigation()

    function renderItem({ item }) {
        return (
            <TouchableOpacity onPress={ ()=> navigation.reset({ routes: [{ name: "Modal", params:{ item: item, array: sweetArray }}]})}  style={styles.container}>
