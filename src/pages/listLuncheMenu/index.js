...
import ListLunch from '../../../assets/lanches'
import lunchArray from '../../../assets/lanches/lunchArray'

import FooterCompenent from '../../components/footerPageComponent'

import ModalMenuList from '../../components/modalMenuList'

export default function ListLunchMenu({ navigation }) {
    ...
    const [list, setList] = useState(lunchArray)
