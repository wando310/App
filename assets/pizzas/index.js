...
import pizzaArray from '../pizzas/pizzaArray'


const ListPizza = ({array}) => {

    const navigation = useNavigation()

    function renderItem({ item }) {
        return (
            <TouchableOpacity onPress={ ()=> navigation.reset({ routes: [{ name: "Modal", params:{ item: item, array: pizzaArray }}]})}  style={styles.container}>
